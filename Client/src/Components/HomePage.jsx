...
export default function HomePage() {
  ...
  // Update Tasks when Notes changes
  useEffect(() => {
    setTasks(Notes);
  }, [Notes]);
  ...
  const handleAddTask = async () => {
    ...
    const data = { UserName: User, Title, Description };
    ...
    <>
      <div className="w-screen h-[91vh] flex items-center text-white flex-col relative">
        ...
        <div className="container w-full h-[75vh] py-2 px-2 flex gap-1 flex-col">
          ...
          {/* Create to add note  */}
          <div
            className="note-container w-full  flex flex-wrap overflow-y-scroll overflow-x-hidden px-3 gap-5
          scrollbar-hide
        "
          >
            {Tasks && Tasks.length ? (
